...
class MaxPool2D(Diffable):
    """2-D max pooling over spatial dimensions.
...
class GlobalMaxPool2D(Diffable):
    """Global max pooling: reduces spatial dimensions to a single value per channel.
